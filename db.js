        ...
        return pgPool.query('SELECT COUNT(*) FROM lotto_hotspots').then(res => {
          if (parseInt(res.rows[0].count) === 0) {
            return pgPool.query(`
              ...
              ('라이프마트', '인천 남동구 간석동 395-2', '1등 18회 / 2등 55회 이상', '인천 남동구 핵심 상권에 위치하여 서울/수도권을 장악하는 강력한 1등 행운 충전소', '인천', 18),
              ('대박천하마트', '인천 부평구 굴포로 48', '1등 12회 / 2등 35회 이상', '부평구 갈산동의 중심 상권에서 한결같은 기류와 대박 기운을 모아 수많은 당첨자를 내는 인천 부평의 자부심', '인천', 12),
              ...
              ('흥양마중물', '강원 원주시 치악로 2335 1층', '1등 8회 / 2등 24회 이상', '원주 치악로 대로변에 위치하여 영험한 치악산의 맑고 강력한 기운을 받아 강원권 최다 1등을 배출한 행운의 산실', '강원', 8),
              ('진평양행', '강원 강릉시 임영로 107', '1등 7회 / 2등 20회 이상', '관동지방 최고의 기맥이 흐르는 임영로 유서 깊은 자리에서 동해 바다의 역동적인 기운과 재물을 모으는 대표 명당', '강원', 7),
              ...
              ('울산대박마트', '울산 남구 삼산동 1521-1', '1등 7회 / 2등 20회 이상', '울산 삼산동 번화가 롯데백화점 인근에서 산업수도의 기운을 가득 모은 금전의 화수분', '울산', 7),
              ('영화유통 (1등복권방)', '울산 남구 신정로 19 삼성아파트 상가 204-101', '1등 14회 / 2등 72회 이상', '울산에서 압도적으로 1등을 가장 많이 배출하며 산업수도의 활기차고 강력한 금전운을 단숨에 사로잡는 영남 대표 명당', '울산', 14),
              ('알리바이', '광주 광산구 신창동 1252-11', '1등 12회 / 2등 40회 이상', '호남 지역의 최대 복권 판매점이자 광주 전남을 아우르는 최고의 1등 노다지 명소', '광주', 12),
              ('금암복권방', '전북 전주시 덕진구 금암동 720', '1등 9회 / 2등 25회 이상', '전주 고속터미널 초입 대로변 가판에서 관광객과 도민들에게 당첨의 기적을 전하는 곳', '전라', 9),
              ('행운의가판 금남로', '광주 동구 금남로5가 183', '1등 7회 / 2등 20회 이상', '금남로의 곧고 깨끗한 기류가 모여 상서로운 운을 이뤄내는 유서 깊은 노점 명당', '광주', 7),
